...
export function RectFidgetSpinner({ type, isActive = false, onKeyboardTrigger }: { type: 'bass' | 'pad', isActive?: boolean, onKeyboardTrigger?: () => void }) {
    ...
    const gridCols = 4;
    const gridRows = 3;
    const width = gridCols * blockSize * 8 + (gridCols - 1) * 4 + 16;
